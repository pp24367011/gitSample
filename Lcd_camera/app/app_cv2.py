...
try:
    ...
    while True:
        ...
        frame_resized = cv2.resize(frame, (240, 280))  # Resize to match LCD resolution
        frame_pil = Image.fromarray(cv2.cvtColor(frame_resized, cv2.COLOR_BGR2RGB))  # Convert OpenCV BGR to PIL RGB
